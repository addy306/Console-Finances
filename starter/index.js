...
function totalMonthsCalc(date) {
  ...
  // Loop through the finance data
  for (var i = 0; i < date.length; i++) {
    // Extract month and year from the date string
    var dateComponents = date[i][0].split('-');
    var monthYear = dateComponents[0] + '-' + dateComponents[1];

    // Check if the month-year combination is not already in the array
  ...
  // Return the total number of unique month-year combinations
